...
$server = Get-OVServer -Name "Synergy-Encl-2, bay 5"
$affinity = "Bay"
# -------------- Connections section
...
$connType = "Ethernet"
$netName = "Prod"
$ThisNetwork = Get-OVNetworkSet -Name $netName
$portID = "Mezz 3:1-c"
$requestedMbps = 2500
$Conn3 = New-OVServerProfileConnection -ConnectionID $connID -Name $connName -ConnectionType $connType -Network $ThisNetwork -PortId $portID -RequestedBW $requestedMbps
...
$portID = "Mezz 3:2-c"
$requestedMbps = 2500
$Conn4 = New-OVServerProfileConnection -ConnectionID $connID -Name $connName -ConnectionType $connType -Network $ThisNetwork -PortId $portID -RequestedBW $requestedMbps
...
$controller1 = New-OVServerProfileLogicalDiskController -ControllerID $deviceSlot -Mode $controllerMode -LogicalDisk $LogicalDisks      
...
New-OVServerProfile -Name $name -Description $description -AssignmentType Server -Server $server -Affinity $affinity -Connections $connections -LocalStorage  -StorageController $controllers -ManageBoot:$manageboot -BootMode $biosBootMode -BootOrder $bootOrder -HideUnusedFlexNics $true
